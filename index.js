...
$("#first_circle").click(function () {
    ...
    if ($("#input").val().trim().length === 0) { null }
        ...
        if ((isDark && width < 500)) { li_create = " <li onmouseover='none'  onmouseleave='none'  id='" + (($("ul li").length) + 1) + "'class='active _li ' ><div onclick='removecheck(this)' class='list_item'><img   id='empty'  class='list_item check  ' src='images/icon-check.svg'></div><p class='list_item' >" + value + "</p><img onclick=' removeparent(this)' class='cross list_item ' src='images/icon-cross.svg' ></li> " }
        else if (isDark && width > 500) {
            li_create = "<li onmouseover='showcross(this)'  onmouseleave='hidecross(this)' id='" + (($("ul li").length) + 1) + "'class='active _li ' ><div onclick='removecheck(this)' class='list_item'><img   id='empty'  class='list_item check  ' src='images/icon-check.svg'></div><p class='list_item' >" + value + "</p><img onclick=' removeparent(this)' class='cross list_item ' src='images/icon-cross.svg' ></li> "
        }

        else if (isDark === false && width < 500) { li_create = "<li style='background-color:rgb(250, 250, 250)' id='" + (($("ul li").length) + 1) + "'class='active _li ' ><div style='background-color:rgb(250, 250, 250);border-color:rgb(210, 211, 219)' onclick='removecheck(this)' class='list_item'><img   id='empty'  class='list_item check  ' src='images/icon-check.svg'></div><p class='list_item' >" + value + "</p><img onclick=' removeparent(this)' class='cross list_item ' src='images/icon-cross.svg' ></li> " }
